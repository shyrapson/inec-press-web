...
export default function EligibilityPage() {
  const positions = [
    ...
    },
    {
      ...
      requirements: [
        "Requirement:",
        "Must be a Serving Corps member. OR",
        "A penultimate student of a Federal/State tertiary institution in Nigeria with a knowledge of IT. OR",
        "A Permanent staff of an MDA with an OND qualification or on GL 07 - 10. OR",
        "INEC permanent staff on Grade Level 07 & 08. OR",
        "A former corps member (Not later than 2022 (i,e 2022, 2023, 2024, 2025)).",
      ],
    },
    {
